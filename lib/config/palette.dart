...
class Palette{
  ...
  static Color secondaryVariant = Colors.white60;
  ...
  static Color darker =  Colors.black87;

  static const Color titleTextColor = const Color(0xff5a5d85);
  static const Color subTitleTextColor = const Color(0xff797878);

  static const Color ftvColorBlue = Color(0xff356DE4);
  static const Color ftvColorGreen = Colors.green; 
  static const Color ftvColorRed = Color(0xffE54141);
  static const Color ftvColorCyan = Color(0xff3DB6BA);
  static Color ftvColorTransparentBlack = Colors.black.withOpacity(0.07);
